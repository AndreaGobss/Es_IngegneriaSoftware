...
\usepackage{altro/breakcites} % https://tex.stackexchange.com/questions/2773/how-do-i-make-latex-push-long-citations-to-a-new-line
\usepackage{hyperref}	% http://tex.stackexchange.com/questions/73862/how-can-i-make-a-clickable-table-of-contents
\usepackage{altro/fancyhdr}	% https://www.sharelatex.com/blog/2013/08/06/thesis-series-pt2.html
\usepackage{altro/titlesec} 	% http://tex.stackexchange.com/questions/11444/how-to-format-the-chapter-heading
...
\usepackage{listings}
\input{altro/fixpseudocode}	% for pseudocodes
\usepackage[backend=biber,style=numeric]{biblatex}
\addbibresource{bibliografia.bib}


%%% Define custom style for lstlisting!
...
\begin{titlepage}
	...
	\centering
	\vspace*{20mm}
	\includegraphics[]{immagini/logo.png}\\
	\vspace*{1cm}
